...
public class MotoristaDTO {
    ...
    private String fotoCnhNome;
    private boolean removerFotoCnh;
    ...
    private String fotoFrenteNome;
    private boolean removerFotoFrente;
    private MultipartFile fotoPlaca;
    private String fotoPlacaNome;
    private boolean removerFotoPlaca;
    ...
    public String getFotoCnhNome() {
        return fotoCnhNome;
    }

    public void setFotoCnhNome(String fotoCnhNome) {
        this.fotoCnhNome = fotoCnhNome;
    }

    public String getFotoFrenteNome() {
        return fotoFrenteNome;
    }

    public void setFotoFrenteNome(String fotoFrenteNome) {
        this.fotoFrenteNome = fotoFrenteNome;
    }

    public String getFotoPlacaNome() {
        return fotoPlacaNome;
    }

    public void setFotoPlacaNome(String fotoPlacaNome) {
        this.fotoPlacaNome = fotoPlacaNome;
    }

    public boolean isRemoverFotoCnh() {
        return removerFotoCnh;
    }

    public void setRemoverFotoCnh(boolean removerFotoCnh) {
        this.removerFotoCnh = removerFotoCnh;
    }

    public boolean isRemoverFotoFrente() {
        return removerFotoFrente;
    }

    public void setRemoverFotoFrente(boolean removerFotoFrente) {
        this.removerFotoFrente = removerFotoFrente;
    }

    public boolean isRemoverFotoPlaca() {
        return removerFotoPlaca;
    }

    public void setRemoverFotoPlaca(boolean removerFotoPlaca) {
        this.removerFotoPlaca = removerFotoPlaca;
    }
}
